...
const EmployeeCreate: React.FC = () => {
    ...
    const onSubmit = (data:EmployeeFormData) => {
        ...
        // use axios post to http://23.133.249.134:8080/api/emp/employees

        axios.post("http://23.133.249.134:8080/api/emp/employees", data)
            .then((response) => {
              ...
              <div className="col-12 col-lg-9 col-xl-7">
                <div className="card shadow-2-strong card-registration" style={{borderRadius: "15px"}}>
                  <div className="card-body p-4 p-md-5">
                    <h3 className="mb-4 pb-2 pb-md-0 mb-md-5">Create Employee</h3>
                      ...
                      <div className="row">
                        <div className="col-md-6 mb-4">
                          ...
                          <label className="form-label" htmlFor="firstName">First Name</label>
                            <input type="text" id="firstName" className="form-control form-control-lg" {...register("first_name", { required: true})}/>
                        ...
                        <div className="col-md-6 mb-4">
                          ...
                          <div className="form-outline">
                            ...
                            <input type="text" id="lastName" className="form-control form-control-lg" {...register("last_name", { required: true})} />
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-6 mb-4 pb-2">
                          ...
                          <label className="form-label" htmlFor="salary">Salary</label>
                            <input type="number" id="salary" className="form-control form-control-lg" {...register("salary", { required: true})} />
                      ...
                      <div className="col-md-6 mb-4">
                          ...
                          <div className="form-check form-check-inline">
                            <input className="form-check-input" type="radio" id="femaleGender"
                              value="female"  {...register("gender", { required: true})}/>
                            <label className="form-check-label" htmlFor="femaleGender">Female</label>
                          </div>
        
                          <div className="form-check form-check-inline">
                            <input className="form-check-input" type="radio" id="maleGender"
                              value="male"   {...register("gender", { required: true})}/>
